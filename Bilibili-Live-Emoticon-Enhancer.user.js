...
(function () {
  ...
  const categories = [
      { emoji: '😄', name: '开心',   words: [
          '哈哈', '笑', '乐', '开心', '愉快', '快乐', '万岁', '自由', '浪起来', '乐观', '耶', '嘻', '草', '嘿嘿', '233', 'hh', '绷不住', 
          '!哭笑不得', '!不乐', '!鲨鱼开心', 
      ...
      { emoji: '😭', name: '难过',   words: [
          '哭', '呜', '泪', '难过', '伤心', '悲伤', '委屈', '想哭', '555', '叹气', '嘤嘤', '唉', '哀', '悲', '神伤', '郁闷', '柠檬', '心痛', '心碎', '伤脑筋', '不乐', '酸了', 
      ...
      { emoji: '🤔', name: '疑惑',   words: [
          '疑惑', '疑问', '问号', '？', '?', '怎么', '为什么', '一脸懵', '懵', '懵逼', '哈？', '啊？', '啥情况', '这啥', '看不懂', '啊咧', 
      ...
      { emoji: '👋', name: '打招呼', words: [
          '你好', '嗨', 'hi', 'hello', '在吗', '起床', '来了', '^早', '欢迎', '在的', '回来', '请多指教', '认识一下',
      ] },
      { emoji: '🚪', name: '再见',   words: [
          '溜了', '下播', '再见', '拜拜', 'bye', '走了', '撤了', '消失', 'run', '拜了', '撤退', '先走一步', '时间', '到点', '结束', '咻', '!贤者时间',
      ] },
      { emoji: '😫', name: '难听折磨', words: [
          '难听', '折磨', '痛苦', '崩溃', 'nooo', '不要', '晕', 'sos', '救命', '打击', '按住', '惊吓', '裂开', '两眼一黑', '寄了', '顶不住', '死了', '去世', '吐', '恶心', '没眼看', '升天', '有蟑螂', '呕', '半死', 
          "!哭晕", 
      ...
      { emoji: '❤️', name: '爱了爱了', words: [
          '喜欢', '喜爱', '爱', '爱了', '爱你', '心动', '真爱', '贴贴', '亲亲', '抱抱', '蹭', '表白', '亲', '害羞', '脸红', '色', 'hso', '爱心', '比心', 'awsl', '期待', '好听', 'mua', 'skr', '羡慕', '玫瑰', '赞美', '鼻血', '一键三', '好看', '好康', '唱歌', '花痴', '心心', '爱心', '两眼一亮', '这个好', 
          '!工作',
      ...
      { emoji: '🙇', name: '对不起',   words: [
          '对不起', '抱歉', '不好意思', '失礼', '冒犯', '对不住'
      ] },
      { emoji: '😡', name: '生气',   words: [
          '生气', '气', '怒', '愤怒', '火大', '不爽', '烦', '恼火', '暴躁', '仇', '红温', '指责', '猫猫流泪', '挑衅', '哼', '傲娇', 
          "!叹气",
      ...
      { emoji: '😱', name: '害怕',   words: [
          '害怕', '发抖', '紧张', '石化', '慌', '不妙', '完了', '吓', '怕', '要完', '啊？', '哈？', '不要过来', '绝望', '糟', 
          "!惊吓兔",
      ] },
      { emoji: '😲', name: '惊讶',   words: [
          '震惊', '惊', '惊讶', '卧槽', '我去', '我靠', '呆', '逆天', '啊？', '慌', '哈？', '啊.', '加载中', '警觉', '愣', '吃鲸', '什么', '糟', 
      ...
      { emoji: '🎉', name: '喝彩',   words: [
          '哇', '牛', 'nb', '厉害', '强', '哇塞', '666', '给力', '呜哇', '稳', '可以的', '祝贺', '恭喜', '撒钱', '干杯', '激动', '生日快乐', '撒花', '过年', '这个好', '鼓掌', '打call', 
      ...
      { emoji: '👍', name: '点赞',   words: [
          '赞', '不错', 'nice', 'good', '棒', '好耶', '支持', '好活', '鸟不起', '资词', '星星眼', '拿捏', '优秀', '哟西', 
      ] },
      { emoji: '😴', name: '睡了劳累',   words: [
          '困', '倦', '睡', '累', '晚安', '哈欠', 'zzz', 'night', '瘫', '升天', '呼噜', '眠', 
      ...
      { emoji: '🪫', name: '摆烂放弃',   words: [
          '不想动', '摆了', '毁灭吧', '无所谓', '寄了', '咕', '休息', '歇', '一滴也没', '心平气和', '功德增加', '蒜鸟', '算了', '完蛋', '瘫', '自闭', '放弃', '佛系', '随缘', 
          '07db01e9df3376e659e8e80915dbe469f63939ff',
          'a0573ca4fa6937983574d7f02e20c84f8b8c91c9',
      ] },
      { emoji: '🙄', name: '尴尬无语',   words: [
          '无语', '无话可说', '服了', '无奈', '尴尬', '社死', '绝了', '离谱', '嫌弃', '石化', '雷', '没辙', '叹气', '随便', '麻烦', '一般', '踢石子', '无聊', '哈欠', '投降', '头痛', '头疼', '我不好说', '麻了', '离大谱', '小丑', '完蛋', '没眼看', '好屑', 'emmm', '挠头', 
      ...
      { emoji: '✔️', name: '附和',   words: [
          '确实', '对对对', '没错', '是的', '有道理', '赞同', '说得对', '正确', 'ok', '可以', '鸟解', '我觉得行', '我觉得星', '靠谱', 
      ...
      { emoji: '🚫', name: '否定拒绝',   words: [
          '不要', '不行', '拒绝', '打咩', '达咩', '不可以', '算了', '别', '不约', '装傻', '一般', '反驳', '不是吧', '离谱了', '扯', '瞎说', '你在说啥', '这不对吧', '胡说', '否认', '不行', '不约', '不可以', '别这样', '想peach', '想桃吃', '下次一定', 
          '!不要过来', '!别急', '!别走', 
          '87c788aa57588c6dac5f15cf02528e584af63307',
          'b694c8d83c0577eef470d4fba84eea95c241aff4', 
      ] },
      { emoji: '🥰', name: '可爱调皮',   words: [
          '可爱', '萌', '卡哇伊', '乖巧', 'kira', '歪头', '歪脑', '软软', 'rua', '超凶', '略略略', '变猪', '嘻嘻', '不愧是我', '得意', '坏笑', '没钱', '学习', 'wink', '耍赖', '鬼脸', '我装的', '挠头', '嘲笑', 
      ...
      { emoji: '💪', name: '加油',   words: [
          '加油', '冲', '努力', '打气', '奥利给', '干杯', '冲鸭', '狠狠干', '拼了', '火力全开', 
          '6339c7ff60c31cdb42af96e94552c790a03401f6',
      ] },
      { emoji: '🍔', name: '吃饭',   words: [
          '吃', '饭', '干饭', '恰饭', '好吃', '美味', '补充', '炫', '饿', '打嗝', '嗦面', '外卖', '碗', 
      ...
      { emoji: '🐟', name: '摸鱼放假',   words: [
          '摸鱼', '摸了', '划水', '偷懒', '摆烂', '躺平', '休息', '歇', '不上班', '下班', '宅', '玩游戏', '看戏', '简单的快乐', 
          '80dc69ad6d0c6858ffee40c8029478bb46745e8f',
      ] },
      { emoji: '💼', name: '上班忙碌',   words: [
          '上班', '忙碌', '加班', '工作', '干活', '搬砖', '社畜', 
          "!不上班",
      ] },
      { emoji: '🥶', name: '好冷',   words: [
          '冷', '冻', '冰', '寒',
      ...
      { emoji: '👊', name: '攻击',   words: [
          '打', '戳', '揍', '锤', '敲', '拍', '拳', '拍', '扇', '削', '叉', 'korosuzo', '凶', '比兜', '威胁', 
          '!打call', '!打咩', '!超凶', '!打动', '!打扰', '!拍拍', 
      ...
      { emoji: '⚡', name: '催促',   words: [
          '快点', '^快', '赶紧', '抓紧', '速度', 'gkd', '^急', 'go', '急急', '快上车', '赶快', 
      ] },
      { emoji: '😎', name: '酷',     words: [
  ...
  function setupEnhancedUI(dialog) {
    ...
    const state = getSearchState(dialog);
    if (state) {
      state.tabs.slice(1).forEach((tab, i) => {
